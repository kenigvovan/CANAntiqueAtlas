...
{
    public class CANGuiDialogEditWayPoint : GuiDialogGeneric
    {
        ...
        public CANWaypoint Waypoint => waypoint;
        ...
        public CANGuiDialogEditWayPoint(ICoreClientAPI capi, CANWaypointMapLayer wml, CANWaypoint waypoint, int index) : base("", capi)
        {
